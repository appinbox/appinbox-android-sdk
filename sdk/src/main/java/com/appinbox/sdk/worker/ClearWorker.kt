...
class ClearWorker(
    ...
    override fun doWork(): Result {
        ...
        clearDevice(appId, appKey, contact, deviceId)
        return Result.success()
    }

    private fun clearDevice(appId: String?, appKey: String?, contact: String?, deviceId: String?) {
        ApiBuilder.getApi().clearDevice(appId, appKey, contact, deviceId).enqueue(object : Callback<Device?> {
